...
let dog :[string, boolean] = ['dog', ture];
// ?기호는 항상 맨 뒤에 붙일 수 있다.
let dag2 :[string, boolean?] = ['dog2', false];
...
let arr :Arr =['anyying', 4000, true, false, true, true, true, false ]
...
function ff(...rest :[string, boolean, ...(number|string)[] ]) {
